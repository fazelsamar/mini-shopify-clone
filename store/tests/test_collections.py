...
class TestCreateCollection:
    ...
    def test_if_user_is_anonymous_return_403(self, create_collection):
...
class TestUpdateCollection:
    ...
    def test_if_user_is_anonymous_return_403(self, update_collection):
...
class TestDestroyCollection:
    ...
    def test_if_user_is_anonymous_return_403(self, delete_collection):
